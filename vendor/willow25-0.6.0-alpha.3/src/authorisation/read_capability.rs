...
wrapper! {
    /// A [valid](https://willowprotocol.org/specs/meadowcap/index.html#cap_valid) read capability.
    ///
    /// ```
    /// use rand::rngs::OsRng;
    ...
    ReadCapability; meadowcap::ReadCapability<MCL, MCC, MPL, NamespaceId, NamespaceSignature, SubspaceId, SubspaceSignature>
}
...
impl ReadCapability {
    ...
    pub fn new_communal(namespace_key: NamespaceId, user_key: SubspaceId) -> Self {
        Self(meadowcap::ReadCapability::new_communal(
            namespace_key,
            user_key,
        ))
    }
    ...
    {
        Self(meadowcap::ReadCapability::new_owned(keypair, user_key))
    }

    /// Returns whether the given area is contained in the [granted area](ReadCapability::granted_area_ref) of this capability.
    ///
    /// ```
    /// use willow25::{prelude::*, authorisation::*};
    ///
...
/// Implements decoding according to the [EncodeMcCapability](https://willowprotocol.org/specs/encodings/index.html#EncodeMcCapability) encoding relation, and further errors if the decoded capability is a read capability.
...
/// Implements decoding according to the [encode_mc_capability](https://willowprotocol.org/specs/encodings/index.html#encode_mc_capability) encoding function, and further errors if the decoded capability is a read capability.
